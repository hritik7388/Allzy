...
export default function Header() {
    ...
    return (
        <header className="sticky top-0 z-50 flex items-center justify-between px-6 py-4 shadow-md bg-gray-100 border-b border-gray-300 relative">
            {/* App Name */}
            <div className="text-2xl font-bold text-gray-900">Allzy</div>
